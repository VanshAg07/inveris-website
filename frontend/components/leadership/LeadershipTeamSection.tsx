        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-12 lg:gap-x-16 max-w-5xl mx-auto">
          {team.members.map((member) => (
            <article key={member.name} className="flex flex-col items-center text-center">
              ...
              <p className="mt-5 text-sm text-paragraph leading-relaxed max-w-md">
                {member.bio}
              </p>
              ...
              <Link
                ...
                className="mt-6 inline-flex h-9 w-9 items-center justify-center rounded-full border border-paragraph-muted/40 text-paragraph-muted hover:border-gold hover:text-gold transition-colors"
